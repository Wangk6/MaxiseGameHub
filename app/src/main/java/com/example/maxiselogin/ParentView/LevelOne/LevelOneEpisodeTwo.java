package com.example.maxiselogin.ParentView.LevelOne;
...
public class LevelOneEpisodeTwo extends AppCompatActivity{
    //Character movements
    ...
    int [] userSequence;
    //Right - Down - Right
    int [] correctSequence = new int[]{3, 2, 3};
    ImageView back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_levelone2);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(LevelOneEpisodeTwo.this, MainLoggedInDifficulty.class);
                startActivity(i);
            }
        });
                                                ...
                                                public void onClick(DialogInterface dialog, int which) {
                                                    switch (which){
                                                        case DialogInterface.BUTTON_POSITIVE:
                                                            //Yes button clicked
                                                            Intent i = new Intent(LevelOneEpisodeTwo.this, LevelOneEpisodeThree.class);
                                                            startActivity(i);
                                                            break;
    ...
    private void PlayAnimation(){
        ...
        ObjectAnimator firstMove = ObjectAnimator.ofFloat(player, "translationX", 530f);
        firstMove.setDuration(1500);
        //Down
        ObjectAnimator rotateUp = ObjectAnimator.ofFloat(player, "rotation", 360f);
        rotateUp.setDuration(100);
        ObjectAnimator secondMove = ObjectAnimator.ofFloat(player, "translationY", 1090f);
        secondMove.setDuration(1500);
        //Right
        ObjectAnimator rotateRight = ObjectAnimator.ofFloat(player, "rotation", 270f);
        rotateUp.setDuration(100);
        ObjectAnimator thirdMove = ObjectAnimator.ofFloat(player, "translationX", 730f);
